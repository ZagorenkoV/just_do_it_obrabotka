...
```
cd existing_repo
git remote add origin https://gitlab.digitalatom.ru/kos-len/asmo-web.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.digitalatom.ru/kos-len/asmo-web/-/settings/integrations)
